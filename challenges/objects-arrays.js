...
const tyrannosaurusTimePeriod = {
  "Time Period": "Late Cretaceous"
}
console.log(tyrannosaurusTimePeriod[`Time Period`]);



// Create a new roar method for the tyrannosaurus.  When called, return "RAWERSRARARWERSARARARRRR!" Log the result.
const tyrannosaurusSpeak = {
    name: 'Tyrannosaurus',
   species: 'Dinosaur',
  favFood: 'other animals',
   roar: 'RAWERSRARARWERSARARARRRR!'
   
  }
console.log(tyrannosaurusSpeak.roar);
